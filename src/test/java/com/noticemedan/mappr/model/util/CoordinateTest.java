...
public class CoordinateTest {
	...
	public void testToCanvasLat_MinimumCase() {
		double convertedCanvasLat = Coordinate.latToCanvasLat(0);
	...
	public void testToLat_MinimumCase() {
		double convertedCanvasLat = Coordinate.latToCanvasLat(0);
		double reversedLat = Coordinate.canvasLatToLat(convertedCanvasLat);
