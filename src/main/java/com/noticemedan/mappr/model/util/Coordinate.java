...
public class Coordinate extends Point2D implements Serializable {
	 ...
	 */
	public static double latToCanvasLat(double lat) {
	 ...
	 */
	public static double lonToCanvasLon(double lon) {
		return lon;
	}
	 ...
	 */
	public static double canvasLatToLat(double canvasLat) {
	 ...
	 */
	public static Point2D viewportPointToCanvasPoint(Point2D viewportPoint, AffineTransform transform) {
